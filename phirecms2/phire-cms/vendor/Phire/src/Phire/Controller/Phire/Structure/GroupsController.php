...
class GroupsController extends AbstractController
{
    ...
    public function index()
    {
        ...
        $this->view->set('title', 'Structure ' . $this->view->separator . ' Fields ' . $this->view->separator . ' Field Groups')
    ...
    public function add()
    {
        ...
        $this->view->set('title', 'Structure ' . $this->view->separator . ' Fields ' . $this->view->separator . ' Field Groups ' . $this->view->separator . ' Add');
    ...
    public function edit()
    {
        if (null === $this->request->getPath(1)) {
            ...
            if (isset($group->id)) {
                $this->view->set('title', 'Structure ' . $this->view->separator . ' Fields ' . $this->view->separator . ' Field Groups ' . $this->view->separator . ' ' . $group->name);
