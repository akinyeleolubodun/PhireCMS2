...
class Install
{
    ...
    public function config($form, $docRoot = null)
    {
        ...
        $db->adapter()->query("UPDATE " . $db->adapter()->escape($dbPrefix) . "content SET created = '" . date('Y-m-d H:i:s') . "', published = '" . date('Y-m-d H:i:s') . "' WHERE id = 6002");
        $db->adapter()->query("UPDATE " . $db->adapter()->escape($dbPrefix) . "content SET created = '" . date('Y-m-d H:i:s') . "', published = '" . date('Y-m-d H:i:s') . "' WHERE id = 6003");
    }
